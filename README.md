...
| 中国大陆 | ❌ Yahoo 对大陆 IP 直接 403 | ❌ 直连不通/不稳，需在海外机房跑（见下方合规租用方式） |
...
获取方式走正规渠道即可：腾讯云、阿里云等国内云厂商都提供**海外地域**的轻量服务器（选美国硅谷/弗吉尼亚等地域），国内账号直接下单、人民币付款、合规可用，月费几十元。我们的生产环境用的就是国内云厂商的美国轻量机。在国内本机跑这套管线不可行，也请勿为此使用任何非合规的网络代理手段。
